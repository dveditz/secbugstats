...
TEAMS = [["Layout",
          "Details.product='Core' AND (Details.component LIKE 'layout%' OR Details.component LIKE 'print%' OR Details.component LIKE 'widget%' OR Details.component IN ('CSS Parsing and Computation','Style System (CSS)','SVG','Internationalization','MathML','Editor') OR Details.component LIKE 'xp toolkit%')"],
         ["Media",
         ...
         ["DOM",
          "Details.product='Core' AND (Details.component LIKE 'DOM%' OR Details.component IN ('Document Navigation','Drag and Drop','Event Handling','HTML: Form Submission','HTML: Parser','RDF','Security','Security: CAPS','Selection','Serializers','Web Services','XBL','XForms','XML','XPConnect','XSLT','XUL'))"],
         ["GFX",
         ...
         ["Frontend",
          "Details.product IN ('Firefox','Firefox for Metro','Toolkit','DevTools','WebExtensions') OR (Details.product='Core' AND (Details.component IN ('Form Manager','History: Global','Identity','Installer: XPInstall Engine','Security: UI','Keyboard: Navigation')))"],
         ["Networking",
         ...
         ["Other",
          "(Details.product='Core' AND (Details.component IN ('DMD','File Handling','General','Geolocation','IPC','Java: OJI','jemalloc','js-ctypes','Memory Allocator','mfbt','mozglue','Permission Manager','Preferences: Backend','Rewriting and Analysis','Security: Process Sandboxing','Spelling checker','String','XPCOM','MFBT','Disability Access APIs','WebVR') OR Details.component LIKE 'Embedding%' OR Details.component LIKE '(HAL)')) OR Details.product='Firefox Build System'"],
         ["Crypto",
         ...
         ["Pocket",
          "Details.product='Pocket'"],
         ["Mobile",
          "Details.product IN ('Fennec Graveyard','Firefox for Android','Android Background Services','Firefox for iOS','Focus-iOS','Focus')"]]
